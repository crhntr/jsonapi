...
func (m *MockDataSetter) SetData(resourceType, id string, attributes interface{}, relationships Relationships, links Linker, meta Meta) error {
...
func (m *MockDataAppender) AppendData(resourceType, id string, attributes interface{}, relationships Relationships, links Linker, meta Meta) error {
...
func (m *MockIncluder) Include(resourceType, id string, attributes interface{}, links Linker, meta Meta) error {
